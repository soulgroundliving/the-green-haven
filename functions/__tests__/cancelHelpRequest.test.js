/**
 * Unit tests for cancelHelpRequest — requester (or admin, for moderation)
...
const { cancelHelpRequest: handler } = require('../cancelHelpRequest');
...
describe('cancelHelpRequest', () => {
  ...
  it('requester cancels an accepted request', async () => {
    seed('r1', 'accepted');
