...
const MIGRATIONS = [
  ...
  ['style="padding:13px; border-radius:12px; border:1px solid #ddd; background:white; color:#666; font-family:inherit; font-weight:700; cursor:pointer;"',
   'ta-input-select'],
  // ── Pass 4 (2× patterns) ─────────────────────────────────────────────────
  ['style="padding: 15px;"',                                     'u-p-15'],
  ['style="padding: 0 15px;"',                                   'u-px-15'],
  ['style="flex:1;min-width:0;"',                                'u-flex-1-min0'],
  ['style="flex:1; min-width:0;"',                               'u-flex-1-min0'],
  ['style="font-size:var(--fs-sm); color:var(--text-muted);"',  'ta-fs-sm-muted'],
  ['style="font-size:var(--fs-sm); color:#888; margin-top:4px;"', 'ta-fs-sm-sub-mt'],
  ['style="font-size:var(--fs-sm); color:#6b7280; padding:0 0 6px 8px;"', 'ta-tag-label'],
  ['style="font-size:var(--fs-sm); color:#666; display:block;"','ta-note-block'],
  ['style="font-size:var(--fs-sm); font-weight:700; color:var(--text-dark); margin:0 0 8px;"', 'ta-label-dark'],
  ['style="font-size:var(--fs-md);font-weight:700;margin-bottom:4px;"', 'ta-md-bold-mb4'],
  ['style="font-size:var(--fs-md); font-weight:600; color:var(--text-dark);"', 'ta-md-600-dk'],
  ['style="font-size:var(--fs-lg); font-weight:800; color:var(--primary-green); margin-bottom:4px;"', 'ta-heading-green'],
  ['style="font-size:var(--fs-lg); color:var(--primary-green);"', 'ta-lg-green'],
  ['style="font-size:9px; opacity:0.8; font-weight:700; text-transform:uppercase; margin:0 0 2px; letter-spacing:.06em;"', 'ta-badge-label'],
  ['style="font-size:1.25rem; font-weight:800; margin:0;"',     'ta-title-xl'],
  ['style="font-size: var(--fs-sm); color: #888; font-weight: 600;"', 'ta-sm-600-sub'],
  ['style="font-size: var(--fs-lg); line-height: 1;"',          'ta-lg-tight'],
  ['style="font-size:var(--fs-sm);color:#9ca3af;"',             'ta-sm-gray'],
  ['style="font-size:var(--fs-sm);color:#6b7280;margin-bottom:4px;"', 'ta-sm-gray-mb4'],
  ['style="font-size:var(--fs-sm);margin-top:8px;padding-top:8px;border-top:1px solid #f0f0f0;color:#374151;"', 'ta-divider-note'],
  ['style="width: 100%; padding: 8px; border: 1px solid #eee; border-radius: 8px; font-size: var(--fs-sm); margin-top: 4px;"', 'ta-input-sm'],
