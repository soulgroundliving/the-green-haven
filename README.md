...
| `npm run test:rules` | Firestore security rules (313 cases) |
...
│   └── __tests__/            # 117 CF unit-test files
├── api/                      # Vercel serverless functions
├── firestore.rules + firestore.rules.test.js  # 313 rule tests
...
- Recurring anti-patterns → logged in CLAUDE.md §7 (currently A–III, 61 patterns)
...
- [CLAUDE.md](CLAUDE.md) — workflow protocol, tech stack details, anti-pattern catalog (§7 A–III)
