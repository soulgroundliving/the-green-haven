...
- Recurring anti-patterns → logged in CLAUDE.md §7 (currently A–JJJ, 62 patterns)
...
- [CLAUDE.md](CLAUDE.md) — workflow protocol, tech stack details, anti-pattern catalog (§7 A–JJJ)
