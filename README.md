...
| `npm run test:rules` | Firestore security rules (314 cases) |
...
├── firestore.rules + firestore.rules.test.js  # 314 rule tests
...
- Recurring anti-patterns → logged in CLAUDE.md §7 (currently A–KKK, 63 patterns)
...
- [CLAUDE.md](CLAUDE.md) — workflow protocol, tech stack details, anti-pattern catalog (§7 A–KKK)
