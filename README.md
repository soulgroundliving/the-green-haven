...
| `npm run test:rules` | Firestore security rules (326 cases) |
...
│   └── __tests__/            # 126 CF unit-test files
...
- Recurring anti-patterns → logged in CLAUDE.md §7 (currently A–LLL, 64 patterns)
...
- [CLAUDE.md](CLAUDE.md) — workflow protocol, tech stack details, anti-pattern catalog (§7 A–LLL)
