...
window.showSubPage = function showSubPage(id) {
    ...
    if (id === 'life-timeline' && typeof window.renderLifeTimeline === 'function') window.renderLifeTimeline();
    ...
    if (id === 'pet-match-page' && typeof window.renderPetMatch === 'function') window.renderPetMatch();
    if (id === 'pet-caretaker-page' && typeof window.renderPetCaretaker === 'function') window.renderPetCaretaker();
    if (id === 'pet-playdate-page' && typeof window.renderPetPlaydates === 'function') window.renderPetPlaydates();
